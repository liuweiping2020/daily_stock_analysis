...
import { BarChart3, Bell, BriefcaseBusiness, Home, LogOut, Megaphone, MessageSquareQuote, Settings2 } from 'lucide-react';
...
const NAV_ITEMS: NavItem[] = [
  ...
  { key: 'publish', label: '发布', to: '/publish', icon: Megaphone },
